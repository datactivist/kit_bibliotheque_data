...
L'outil "Rapports" proposé par l'observatoire de la Région Sud permet de produire rapidement une série d'indicateurs essentiels pour dresser un portrait de territoire. Comme dans l'outil carte, l'interface se décompose en deux espaces : pilotage du rapport à gauche et visualisation du rapport à droite. 
...
Toujours dans le menu Actions, la fonction "Imprimer tout" assemble tous chapitres du rapport en un seul document. 
