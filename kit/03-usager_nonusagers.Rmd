...
Pour connaître les options disponibles, il vous suffit de cliquer sur le bouton **Export/Intégrer** juste à droite du graph :
...
* intégrer la visualisation à une page HTML avec un **iframe**, c'est-à-dire un cadre d'affichage à l'intérieur duquel sera repris le graph comme il apparaît sur le site.
